Resumo do projeto:O objetivo desse projeot principal foi entender uma pouco mais sobre as manipulações do JavaScript no HTML,tambem podendo proporcionar algo que sera utilizado no dia a dia   
